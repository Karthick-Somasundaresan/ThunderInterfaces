...
namespace QualityAssurance {
    ...
    enum IDS : uint32_t {
        ...
        ID_SAMPLERDKPLUGIN                           = RPC::IDS::ID_EXTERNAL_QA_INTERFACE_OFFSET + 0x030,
        ID_SAMPLERDKPLUGIN_NOTIFICATION              = ID_SAMPLERDKPLUGIN + 1,

        ID_SAMPLERDKDEPENDENCYPLUGIN                 = RPC::IDS::ID_EXTERNAL_QA_INTERFACE_OFFSET + 0x040,
        ID_SAMPLERDKDEPENDENCYPLUGIN_NOTIFICATION    = ID_SAMPLERDKDEPENDENCYPLUGIN + 1,

        ID_SUBSYSTEMCONTROLLERPLUGIN                 = RPC::IDS::ID_EXTERNAL_QA_INTERFACE_OFFSET + 0x050,
        ID_SUBSYSTEMCONTROLLERPLUGIN_NOTIFICATION    = ID_SUBSYSTEMCONTROLLERPLUGIN + 1,

        ID_SUBSYSDEPENDENTPLUGIN                     = RPC::IDS::ID_EXTERNAL_QA_INTERFACE_OFFSET + 0x060,
        ID_SUBSYSDEPENDENTPLUGIN_NOTIFICATION        = ID_SUBSYSDEPENDENTPLUGIN + 1,
    };
}
}
